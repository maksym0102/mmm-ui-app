...
let databaseUtility = require("./modules/DatabaseUtility");
const browserUtility = require("./modules/BrowserWindowUtility");
const installUtility = require("./modules/InstallUtility");
const path = require("path");
require("./modules/IpcHandlers");
let configDir = (app || remote.app).getPath("userData");
...
app.on("ready", async () => {
    ...
    installUtility.checkJavaInstallation();
    createWindow();
});
